...
const Page: NextPageWithLayout = () => {
  ...
  return (
    <main className={styles.main}>
      <article ref={aboutRef} id="aboutSection">
        <About />
      </article>
      <article ref={skillsRef} id="skillsSection">
        <Skills />
      </article>
      <article ref={archiveRef} id="archiveSection">
        <Archive />
      </article>
      <article ref={projectRef} id="projectSection">
        <Project />
      </article>
    </main>
  )
